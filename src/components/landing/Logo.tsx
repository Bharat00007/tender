export function Logo({ tone = "dark" }: { tone?: "dark" | "light" }) {
  ...
  return (
    <a href="#top" className={`flex items-center gap-2.5 ${color}`} aria-label="Tendor home">
      ...
      <span className="text-[0.8rem] font-medium uppercase tracking-[0.3em]">Tendor</span>
    </a>
  );
}
